...
const TRANSLATIONS = {
  ...
  es: {
    ...
    'bot.desc':             'El bot monitorea tu rango LP en ambas direcciones: abre un SHORT cuando el precio cae por debajo del rango y un LONG cuando supera el límite superior — compensando la pérdida impermanente en ambos escenarios.',
  ...
  en: {
    ...
    'bot.desc':             'The bot monitors your LP range in both directions: opens a SHORT when price drops below the range and a LONG when it breaks above the upper bound — offsetting impermanent loss in both scenarios.',
