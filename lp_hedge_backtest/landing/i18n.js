...
const TRANSLATIONS = {
  ...
  es: {
    ...
    'bot.desc':             'El bot monitorea tu rango LP: abre un SHORT cuando el precio entra al rango desde el techo, compensando la pérdida impermanente. Trailing stop automático protege las ganancias; se rearma solo cuando el precio se recupera.',
    ...
    'bot.stat.hedge':       'P&G Cobertura',
    'bot.stat.hedge.short': 'P&G Cobertura SHORT',
    'bot.stat.hedge.long':  'P&G Cobertura LONG',
    'bot.stat.hedge.note':  'Bot inactivo — precio en rango',
    'bot.stat.net':         'Resultado Neto',
    'bot.stat.net.note':    'LP + Cobertura combinados',
    // ── Animation dynamic labels ──────────────────────────────────────
    'bot.pill.idle':              '● Monitoreando...',
    'bot.pill.short.trigger':     '⚡ Cobertura Disparada',
    'bot.pill.short.active':      '🛡 SHORT Activo',
    'bot.pill.short.close':       '✓ Short Cerrado',
    'bot.pill.long.trigger':      '⚡ LONG Disparado',
    'bot.pill.long.active':       '🚀 LONG Activo',
    'bot.pill.long.close':        '✓ Long Cerrado',
    'bot.anim.short.active':      '⚡ SHORT ACTIVO',
    'bot.anim.long.active':       '🚀 LONG ACTIVO',
    'bot.stat.hedge.note.short':  'SHORT activo — compensando pérdida',
    'bot.stat.hedge.note.long':   'LONG activo — capturando upside',
    'bot.stat.hedge.note.idle':   'Bot inactivo — precio en rango',
    'bot.stat.lp.note.in':        'En rango — acumulando comisiones',
    'bot.stat.lp.note.below':     'Fuera de rango — pérdida:',
    'bot.stat.lp.note.above':     'Sobre rango — todo en USDC',
    ...
    'perf.netRealizedPnl':  'P&L Neto Realizado',
    'perf.totalTrades':     'Operaciones',
    'perf.winRate':         'Win Rate',
    'perf.profitFactor':    'Profit Factor',
    'perf.botPnl':          'P&L Bots',
    'perf.signalPnl':       'P&L Señales',
    'perf.feesPaid':        'Comisiones',
    'perf.fundingPaid':     'Funding',
    'perf.equityCurve':     'Curva de Capital',
    'perf.breakdown':       'Desglose',
    'perf.byPair':          'Par',
    'perf.byMode':          'Modo',
    'perf.byMonth':         'Mes',
    'perf.tradeJournal':    'Diario de Operaciones',
    'perf.date':            'Fecha',
    'perf.mode':            'Modo',
    'perf.pair':            'Par',
    'perf.side':            'Lado',
    'perf.netPnl':          'P&L Neto',
    'perf.realizedPnl':     'P&L Realizado',
    ...
    'perf.from':            'Desde',
    'perf.to':              'Hasta',
    'perf.refresh':         'Actualizar',
    'perf.exportCsv':       'Exportar CSV',
    'perf.prev':            'Anterior',
    'perf.next':            'Siguiente',
    ...
    'prot.mode.aragan.desc':      'SHORT solo cuando el precio rompe por debajo del rango. En subidas, la LP captura toda la ganancia libremente.',
    'prot.mode.soon':             'Próximamente',
    'prot.mode.avaro':            'Defensor Alcista',
    'prot.mode.avaro.desc':       'SHORT cuando el precio entra al rango desde arriba. SL ajustado + trailing stop automático. Re-armado tras cada cierre.',
    ...
    'prot.wallet.hint':           'Ingresa tu wallet para ver el balance disponible',
  ...
  en: {
    ...
    'bot.desc':             'The bot monitors your LP range: opens a SHORT when price enters from the range ceiling, offsetting impermanent loss. Automatic trailing stop locks in profit; re-arms when price recovers.',
    'bot.chart.title':      'Live Animated Simulation',
    'bot.chart.loop':       '↺ Auto loop',
    'bot.stat.lp':          'LP Position Value',
    'bot.stat.lp.note':     'In range — earning fees',
    'bot.stat.hedge':       'Hedge P&L',
    'bot.stat.hedge.short': 'Hedge P&L SHORT',
    'bot.stat.hedge.long':  'Hedge P&L LONG',
    'bot.stat.hedge.note':  'Bot idle — price in range',
    'bot.stat.net':         'Net Result',
    'bot.stat.net.note':    'LP + Hedge combined',
    // ── Animation dynamic labels ──────────────────────────────────────
    'bot.pill.idle':              '● Monitoring...',
    'bot.pill.short.trigger':     '⚡ Hedge Triggered',
    'bot.pill.short.active':      '🛡 SHORT Active',
    'bot.pill.short.close':       '✓ Short Closed',
    'bot.pill.long.trigger':      '⚡ LONG Triggered',
    'bot.pill.long.active':       '🚀 LONG Active',
    'bot.pill.long.close':        '✓ Long Closed',
    'bot.anim.short.active':      '⚡ SHORT ACTIVE',
    'bot.anim.long.active':       '🚀 LONG ACTIVE',
    'bot.stat.hedge.note.short':  'SHORT active — offsetting loss',
    'bot.stat.hedge.note.long':   'LONG active — capturing upside',
    'bot.stat.hedge.note.idle':   'Bot idle — price in range',
    'bot.stat.lp.note.in':        'In range — earning fees',
    'bot.stat.lp.note.below':     'Out of range — loss:',
    'bot.stat.lp.note.above':     'Above range — all in USDC',
    ...
    // ── Performance dashboard ─────────────────────────────────────
    'perf.netRealizedPnl':  'Net Realized P&L',
    'perf.totalTrades':     'Trades',
    'perf.winRate':         'Win Rate',
    'perf.profitFactor':    'Profit Factor',
    'perf.botPnl':          'Bot P&L',
    'perf.signalPnl':       'Signal P&L',
    'perf.feesPaid':        'Fees Paid',
    'perf.fundingPaid':     'Funding Paid',
    'perf.equityCurve':     'Equity Curve',
    'perf.breakdown':       'Breakdown',
    'perf.byPair':          'Pair',
    'perf.byMode':          'Mode',
    'perf.byMonth':         'Month',
    'perf.tradeJournal':    'Trade Journal',
    'perf.date':            'Date',
    'perf.mode':            'Mode',
    'perf.pair':            'Pair',
    'perf.side':            'Side',
    ...
    'prot.mode.aragan':           'Defensor Bajista',
    'prot.mode.aragan.desc':      'SHORT only when price breaks below the range. On upside, LP captures all gains freely.',
    'prot.mode.soon':             'Coming Soon',
    'prot.mode.avaro':            'Defensor Alcista',
    'prot.mode.avaro.desc':       'SHORT when price enters range from above. Tight SL + automatic trailing stop. Re-arms after every close.',
    ...
    'prot.wallet.hint':           'Enter your wallet to see available balance',
