...
const TRANSLATIONS = {
  ...
  es: {
    ...
    'prot.mode.aragan':           'Defensor Bajista (solo cobertura)',
    'prot.mode.avaro':            'Avaro (cobertura + long)',
    'prot.trigger.label':         'Disparador (% bajo piso)',
    'prot.hedgesize.label':       'Tamaño Cobertura (% capital)',
    'prot.exchange.label':        'Exchange',
    'prot.apikey.label':          'API Key Hyperliquid',
    'prot.apikey.placeholder':    'Pega tu API Key de HL',
  ...
  en: {
    ...
    'prot.mode.aragan':           'Defensor Bajista (hedge only)',
    'prot.mode.avaro':            'Avaro (hedge + long)',
    'prot.trigger.label':         'Trigger (% below floor)',
    'prot.hedgesize.label':       'Hedge Size (% of capital)',
    'prot.exchange.label':        'Exchange',
    'prot.apikey.label':          'Hyperliquid API Key',
    'prot.apikey.placeholder':    'Paste your HL API Key',
