...
- **2026-04-10 (platform):** Explorar moved to its own landing page (`landing/explore/index.html`). Removed from LP Defensor tab bar. DeFi nav dropdown updated across all 5 pages (dashboard, whale, wallet, whitepaper, explore) with 🔍 Explorar entry. Reuses dashboard.js + dashboard.css — no code duplication.
