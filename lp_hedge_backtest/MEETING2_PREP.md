...
| M2-6 | Buffer Capital pill buttons (Sin/+10/+20/+30/+50%) | Low | Cleaner than slider, shows options at a glance | ✅ Done 2026-04-25 — pills above hedge slider: Sin/+10%/+20%/+30%/+50%/+100%, update slider + active highlight on click |
| M2-7 | Backtesting link/embed inside LP Defensor | Low | Bring it closer to the product, not a separate page | ✅ Done 2026-04-25 — "📊 Ver Backtester →" link in position card footer, links to / |
...
*Last updated: 2026-04-23 — M2-39 CB live-validated (fired 20:02 UTC Config 20, 20-min pause confirmed) + DB enum fix. M2-9 ✅ M2-13 ✅ M2-21 ✅ M2-39 ✅ M2-40 ✅ all live-validated. M2-29 deferred.*
